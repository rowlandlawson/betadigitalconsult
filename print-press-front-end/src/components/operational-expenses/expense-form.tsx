...
import { CreateExpenseData, UpdateExpenseData, OperationalExpense } from '@/types/operational-expenses';
...
export const ExpenseForm: React.FC<ExpenseFormProps> = ({ expenseId, mode }) => {
  ...
  return (
    <Card>
      <CardHeader>
        <h2 className="text-2xl font-bold">{mode === 'create' ? 'Add Operational Expense' : 'Edit Expense'}</h2>
      </CardHeader>
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex gap-4 pt-4">
            ...
            <Button type="button" variant="outline" onClick={() => router.push('/admin/operational-expenses')}>
              Cancel
            </Button>
          </div>
        </form>
