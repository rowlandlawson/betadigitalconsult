...
export const WorkerCustomerList: React.FC = () => {
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-gray-600">View customer contact information</p>
        </div>
      </div>
      ...
      {/* Summary Cards - Only non-financial stats */}
      ...
      {/* Customers List - No financial data */}
      <Card>
        <CardHeader>
